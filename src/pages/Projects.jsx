                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-800">
                                    <tr>
                                        <th scope="col" className={classList.th}>Project Image</th>
                                        <th scope="col" className={classList.th}>Project Name</th>
                                        <th scope="col" className={classList.th}>Short Name</th>
                                        <th scope="col" className={classList.th}>Technologies</th>
