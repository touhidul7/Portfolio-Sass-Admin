      ...
      {loading ? (
        ...
        <>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-6 gap-6">
              {socialFields.map((field) => (
                <div key={field} className="col-span-6 sm:col-span-3">
                  <label htmlFor={field} className={classList.label}>
                    {field}
                  </label>
                  <input
                    type={`${
            ...
            <div className="grid grid-cols-2 lg:gap-6 md:gap-4 gap-2 mt-6">
              <div className="">
              ...
              {editId && (
                <div className="">
                  ...
                  <button
                    className={`${classList.button} btn bg-red-500`}
                    onClick={() => {
                      ...
                      toast.promise(
                        axios
                          .delete(
                            `${VITE_SERVER_API}/profiles/${profilesData[0]._id}`
                          )
                          .then(() => {
                            setProfilesData([]);
                          }),
